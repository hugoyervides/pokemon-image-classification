...
def load_data(dataset_path):
    ...
    dev_dataset = h5py.File(dataset_path, "r")
    dev_set_x_orig = np.array(dev_dataset["dev_img"][:]) # your test set features
    dev_set_y_orig = np.array(dev_dataset["dev_labels"][:]) # your test set labels
...
def initialize_parameters_deep(layer_dims):
    ...
    for l in range(1, L):
        parameters['W' + str(l)] = cp.random.randn(layer_dims[l], layer_dims[l-1]) / cp.sqrt(layer_dims[l-1]) #*0.01
